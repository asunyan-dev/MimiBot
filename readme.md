# MimiBot - Multifunction User/Server Discord Bot
...
- The first is to download the code as zip and extract it. [Download here](https://github.com/asunyan-dev/MimiBot/archive/refs/heads/main.zip)
...
```bash
$ git clone https://github.com/asunyan-dev/MimiBot.git
```
...
2. Configure the code.
 - Open your code editor in the bot's folder. In the root folder, create a file called <ins>.env</ins>
