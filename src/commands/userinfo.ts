import { ChatInputCommandInteraction, SlashCommandBuilder, InteractionContextType, EmbedBuilder, MessageFlags } from "discord.js";
...
export default {
    data: new SlashCommandBuilder()
        ...
        .addUserOption((option) => 
            option
                .setName("user")
                .setDescription("User to check info for")
                .setRequired(false)
        ),
