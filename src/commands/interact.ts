...
export default {
    data: new SlashCommandBuilder()
        .setName("interact").setDescription("Interact with others")
        .addSubcommand(sub => 
            sub.setName("cuddle").setDescription("Cuddle another user")
            .addUserOption(option => 
                option.setName("user").setDescription("The user to cuddle").setRequired(true)
            )
        )
        .addSubcommand(sub => 
            sub.setName("hug").setDescription("Hug another user")
            .addUserOption(option => 
                option.setName("user").setDescription("The user to hug").setRequired(true)
            )
        )
        .addSubcommand(sub => 
            sub.setName("kiss").setDescription("Kiss another user")
            .addUserOption(option => 
                option.setName("user").setDescription("The user to kiss").setRequired(true)
            )
        )
        .addSubcommand(sub => 
            sub.setName("pat").setDescription("Pat another user")
            .addUserOption(option => 
                option.setName("user").setDescription("The user to pat").setRequired(true)
            )
        )
        .addSubcommand(sub => 
            sub.setName("smug").setDescription("Smug at another user")
            .addUserOption(option => 
                option.setName("user").setDescription("The user to smug at").setRequired(true)
            )
        ),
